...
>>>>>>> 7628423ccd79f0cd25debbd4f53acd848ac373d6
          ...
          body: JSON.stringify({ query: 'politics', page }),
        });
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 pt-32">
        <div className="text-center text-blue-500 text-xl">Loading politics news...</div>
      </div>
    );
  }
  ...
  if (articles.length === 0) {
    return (
      <div className="container mx-auto px-4 pt-32">
        <div className="text-center text-gray-500 text-xl">No politics news available.</div>
      </div>
    );
  }
