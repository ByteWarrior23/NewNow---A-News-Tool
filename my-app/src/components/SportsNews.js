    ...
    const fetchNews = async () => {
      ...
      try {
        ...
        const res = await fetch(`${backendUrl}/api/news`, {
          ...
          body: JSON.stringify({ query: 'sports', page }),
        });
  ...
  return (
    <main className="container mx-auto px-4 pt-32 font-sans fade-in bg-white dark:bg-zinc-900 transition-colors duration-300 min-h-screen">
      <section className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-3 text-dark dark:text-white">Sports News</h1>
        <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto leading-7">Latest sports news, curated for you. Powered by NewsAPI.org.</p>
      </section>
