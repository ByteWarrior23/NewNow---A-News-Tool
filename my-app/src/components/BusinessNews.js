...
const BusinessNews = () => {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 pt-32">
        <div className="text-center text-blue-500 text-xl">Loading business news...</div>
      </div>
    );
  }
  ...
  if (articles.length === 0) {
    return (
      <div className="container mx-auto px-4 pt-32">
        <div className="text-center text-gray-500 text-xl">No business news available.</div>
      </div>
    );
  }
